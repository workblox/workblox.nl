...
export const handler = init({
	...
	_: {
		entry: {"file":"_app/immutable/start-5e587038.js","imports":["_app/immutable/start-5e587038.js","_app/immutable/chunks/index-97bd7e1c.js","_app/immutable/chunks/i18n-util-d14141ef.js","_app/immutable/chunks/preload-helper-41c905a7.js"],"stylesheets":[],"fonts":[]},
		nodes: [
		...
		matchers: async () => {
			const { match: langCode } = await import ('../server/entries/matchers/langCode.js')
			return { langCode };
		}
	}
});
