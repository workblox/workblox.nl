		...
		<div class="-mx-4 flex flex-wrap">
			<div class="w-full px-4">
				<div class="mb-12 max-w-[800px] lg:mb-20">
					...
					>
						Wij geloven in efficiënter werken. Het digitaliseren van uw werkproces levert u en uw klant een hoop voordelen op.
					</p>
				</div>
			</div>
		</div>
		<div class="-mx-4 flex flex-wrap">
			...
			<div class="w-full px-4 md:w-1/2 lg:w-1/4">
				...
				>
					...
					<h4 class="mb-3 text-xl font-bold text-dark">
						Centrale informatie-uitwisseling
					</h4>
					<p class="mb-8 text-body-color lg:mb-11">
			...
			<div class="w-full px-4">
				<div class="mb-12 max-w-[620px] lg:mb-20">
					...
					<p
						class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
					>
						Door uw werkprocessen eenvoudig te automatiseren bespaart u tijd en optimaliseert u uw klantcontact.
					</p>
				</div>
			</div>
		</div>
