...
const nl: BaseTranslation = {
	...
	footer: {
		title: 'Ons doel is om het internet toegankelijker te maken voor middelgrote en kleine bedrijven. <br /><br /> Je ons mailen voor vragen, opmerkingen of meer informatie.'
	},
	contact: {
