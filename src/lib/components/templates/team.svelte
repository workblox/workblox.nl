		...
		<div class="-mx-4 flex flex-wrap">
			<div class="w-full px-4">
				<div class="mx-auto mb-[60px] max-w-[620px] text-center">
					<span class="mb-2 block text-lg font-semibold text-dark"> Ons team </span>
					...
					<p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
						Ontdek de krachten achter Workblox, zij werken elke dag hard aan het verbeteren en
						ontwikkelen van het de app.
					</p>
				</div>
			</div>
		</div>
		...
		<div class="-mx-4 flex flex-wrap justify-center">
			<div class="w-full px-4 sm:w-1/2 lg:w-1/4">
				<div class="wow fadeInUp mb-10" data-wow-delay=".1s">
					...
					<div class="text-center">
						<h4 class="mb-2 text-lg font-medium text-dark">Harmen van Balen</h4>
						<p class="mb-5 text-sm font-medium text-body-color">UI/UX Designer</p>
						<div class="flex items-center justify-center">
							<a
								href="/"
								class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-dark"
							>
			...
			<div class="w-full px-4 sm:w-1/2 lg:w-1/4">
				<div class="wow fadeInUp mb-10" data-wow-delay=".15s">
					...
					<div class="text-center">
						<h4 class="mb-2 text-lg font-medium text-dark">Peter Knijff</h4>
						<p class="mb-5 text-sm font-medium text-body-color">Developer</p>
						<div class="flex items-center justify-center">
							<a
								href="/"
								class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-dark"
