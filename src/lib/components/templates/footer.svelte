...
<footer class=" relative z-10 bg-rice-flower pt-20 lg:pt-[120px]">
	<div class="container">
		<div class="-mx-4 flex flex-wrap">
			<div class="w-full px-4 lg:w-6/12">
				<div class="mb-10 md:mb-16 w-full">
					<a href="/" class="mb-6 inline-block max-w-[160px]">
						<img src="/assets/images/logo/logo-white.svg" width="146" height="36" loading="lazy" alt="logo" class="max-w-full" />
					</a>
				...
				<div class="w-full px-4">
					<div class="my-1 flex justify-between">
						...
						<div class="-mx-3 flex items-center">
							<a href="https://www.linkedin.com/company/workblox" target="_blank" class="px-3 text-dark" data-role="linkedIn">
							...
							<a href="https://www.instagram.com/workblox.nl/" target="_blank" class="px-3 text-dark" data-role="instragram">
								<svg width="18" height="18" viewBox="0 0 18 18" class="fill-current">
									<path
							...
							<a href="https://www.facebook.com/workbloxnl" target="_blank" class="px-3 text-dark" data-role="facebook">
								<svg
									width="10"
									height="18"
									viewBox="0 0 10 18"
							...
							<a href="https://twitter.com/workblox" target="_blank" class="px-3 text-dark" data-role="twitter">
