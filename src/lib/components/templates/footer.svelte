...
<footer
	class='wow fadeInUp relative z-10 bg-rice-flower pt-20 lg:pt-[120px]'
	data-wow-delay='.15s'
>
	<div class='container'>
		<div class='-mx-4 flex flex-wrap'>
			<div class='w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12'>
				<div class='mb-10 w-full'>
					...
					<Anchor>{$LL.contact.email()}</Anchor>
				</div>
			</div>
			<div class='hidden lg:block w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12'>
				<div class='mb-10 w-full'>
					<h4 class='mb-9 text-lg font-semibold text-dark'>About Us</h4>
					<ul>
						<li>
							<a
								href='/'
								class='mb-2 inline-block text-base leading-loose text-dark'
							>
								Home
							</a>
						</li>
			...
			<div class='hidden lg:block w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12'>
				<div class='mb-10 w-full'>
					<h4 class='mb-9 text-lg font-semibold text-dark'>Features</h4>
					<ul>
						<li>
							<a
								href='/'
			...
			<div class='-mx-4 flex flex-wrap'>
				<div class='w-full px-4'>
					<div class='my-1 flex justify-between'>
						<p class='text-dark'>Blijf op de hoogte</p>
