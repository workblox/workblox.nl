			...
			<div class="-mx-4 flex flex-wrap">
				<div class="w-full px-4">
					<div class="items-center justify-between overflow-hidden border lg:flex">
						...
						>
							<span class="mb-5 inline-block bg-primary py-2 px-5 text-sm font-medium text-dark">
								About Us
							</span>
							<h2
							...
							<a
								href="/"
								class="inline-flex items-center justify-center rounded bg-primary py-4 px-6 text-base font-medium text-dark transition duration-300 ease-in-out hover:bg-opacity-90 hover:shadow-lg"
							>
								Learn More
							</a>
						</div>
